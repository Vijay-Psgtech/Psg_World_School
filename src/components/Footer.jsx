      ...
      <div className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row gap-8 md:gap-0 justify-between items-start">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start md:w-2/5">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <a href="tel:04224344522" className="text-blue-600 hover:underline">
                0422 4344522
              </a>
            </div>
            <div className="flex items-center gap-2 mb-1">
              <FiPhone className="text-blue-500" />
              <a href="tel:04224344220" className="text-blue-600 hover:underline">
                0422 4344220
              </a>
            </div>
            <div className="flex items-center gap-2">
              <FiMail className="text-blue-500" />
              <a href="mailto:info@bvmglobal.org" className="text-blue-600 hover:underline">
                info@bvmglobal.org
              </a>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 w-full md:w-3/5">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li><a href="/programmes" className="hover:underline">Our Programmes</a></li>
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li><a href="/news" className="hover:underline">Careers & News</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold mb-2">Legal</h4>
            <ul className="space-y-1">
              <li><a href="/mandatory-disclosure" className="hover:underline">Mandatory Disclosure</a></li>
              <li><a href="/organisational-policy" className="hover:underline">Organisational Policy</a></li>
