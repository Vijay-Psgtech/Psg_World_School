  ...
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
    ...
    <div>
      ...
      <p className="text-gray-700 text-lg leading-relaxed">
        At <span className="font-semibold text-emerald-700">PSG Global Coimbatore</span>, 
        education goes beyond textbooks. Our programs ignite curiosity, 
        inspire purpose, and transform learners into confident World School citizens. 
        Powered by <span className="font-semibold">Veranda K-12</span>, we 
        integrate academic rigor, creativity, well-being, and future-ready 
        skills for a holistic journey.
      </p>
    </div>
     ...
     <section className="relative py-24 px-6 bg-gradient-to-r from-purple-100 via-pink-50 to-orange-50">
      ...
      <div className="relative max-w-7xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 drop-shadow-sm mb-6">
          Curriculum Designed for the <span className="text-pink-600">21st Century</span>
        </h2>
        <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-16">
          We offer the <span className="font-semibold text-pink-600">CBSE curriculum</span> (Grades I–XII) 
          for structured academic excellence. Additionally, 
          <span className="font-semibold text-purple-600"> NIOS</span> provides a flexible alternative 
 ...
 <section className="relative py-24 px-6 bg-gradient-to-r from-indigo-50 via-blue-50 to-cyan-50 overflow-hidden">
    ...
    <section className="relative py-24 px-6 bg-gradient-to-b from-emerald-50 via-green-100/60 to-white overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto text-center">
        ...
        >
          Empowering our students at PSG Global Coimbatore to secure admissions in
          top universities and colleges worldwide with ease.
        </motion.p>
