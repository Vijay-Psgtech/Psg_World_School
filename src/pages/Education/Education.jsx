...
function Education() {
  ...
  return (
    <section className="w-full py-12 px-6 md:px-12 flex gap-6 justify-center bg-purple-50 flex-wrap">
        <p className='w-16 border-t-2 border-blue-600 mb-2'></p>
        <h1 className="text-4xl font-bold text-gray-900 mb-12 text-center w-full">
            Education Programs
        </h1>
